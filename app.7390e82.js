...
`;var _=t(7909),B=t(9879);const I=({onClick:n,children:e})=>(0,C.Y)(M,{onClick:n},e),R=k.Ay.button`
  display: flex;
  align-items: center;
  justify-content: center;
  padding: ${n=>n.theme.spacing.medium}
